...
// Fri Nov  9 14:51:37 2018 by ROOT version 6.12/07
...
void BsPhiLLTupleTree::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("muIDMVA_lead", &muIDMVA_lead, &b_muIDMVA_lead);
   ...
   fChain->SetBranchAddress("muIDMVA_sublead", &muIDMVA_sublead, &b_muIDMVA_sublead);
...
Float_t BsPhiLLTupleTree::deltaPhi(Float_t phi1, Float_t phi2)
{
   ...
   //return pow(TMath::ATan2(TMath::Sin(dphi), TMath::Cos(dphi)), 2);
