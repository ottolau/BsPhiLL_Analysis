...
def build_custom_model(n_estimators=100, max_depth=3, learning_rate=1.e-3):#, 
    ...
    #gb = GradientBoostingClassifier(n_estimators=n_estimators, learning_rate=learning_rate, max_depth=max_depth, min_samples_split=min_samples_split, min_samples_leaf=min_samples_leaf)
